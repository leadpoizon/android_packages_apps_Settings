...
import com.android.settings.nexus.SeekBarPreference;
...
public class RecentAppSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.nexus_recent_app_settings);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mRecentsClearAllLocation) {
            ...
            Settings.System.putInt(getActivity().getContentResolver(), Settings.System.RECENT_PANEL_BG_COLOR, (Integer) newValue);
            ...
            Settings.System.putInt(getActivity().getContentResolver(), Settings.System.RECENT_CARD_BG_COLOR, (Integer) newValue);
            preference.setSummary(((ColorPickerPreference) preference).getSummaryText() + ColorPickerPreference.convertToARGB((Integer) newValue));
            return true;
        } else if (preference == mRecentCardTextColor) {
            Settings.System.putInt(getActivity().getContentResolver(), Settings.System.RECENT_CARD_TEXT_COLOR, (Integer) newValue);
            preference.setSummary(((ColorPickerPreference) preference).getSummaryText() + ColorPickerPreference.convertToARGB((Integer) newValue));
            return true;
        }
        return false;
